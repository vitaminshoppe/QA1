...
ARCDIR=$LOGDIR/arch
LOGFILE1=$LOGDIR/CCLog.OMS
#LOGFILE2=$LOGDIR/FTC_CANCEL_ORDERS.txt
#LOGFILE2=$LOGDIR/CCMissingExpiryDate2.txt
#TO_ADDRS="oms@vitaminshoppe.com"
TO_ADDRS="Chandana.Das@vitaminshoppe.com"
...
AND SYSDATE - YORS.STATUS_DATE > '0.03' 
...
then
echo -e "This morning’s query displayed no orders stuck in Created status." | mailx -r "oms_auto_notification@vitaminshoppe.com" -s "No orders stuck in Release or Store Received status.Count:$orderCount" $TO_ADDRS
