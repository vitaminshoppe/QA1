...
LOGFILE3=$LOGDIR/DTC_MonitorOrderResults_Fraud_1.txt
#LOGFILE4=$LOGDIR/DTC_MonitorOrderResults_AwaitPayInfo.txt
LOGFILE5=$LOGDIR/DTC_MonitorOrderResults_Other_1.txt
...
#FRAUD_ADDRS="omnicustomercare@vitaminshoppe.com oms@vitaminshoppe.com operators@vitaminshoppe.com navichal@vitaminshoppe.com Lauren.Alfant@vitaminshoppe.com sjordan@vitaminshoppe.com Amanda.Alfonso@vitaminshoppe.com rlora@vitaminshoppe.com DSoneji@vitaminshoppe.com"
...
FRAUD_ADDRS="shivraj.ugale@vitaminshoppe.com"
...
then
echo -e "No DTC orders are stuck in Created status with Fraud Hold.\n\nScript Name:Orders_Stuck_Created_Status.sh \nCriteria: Orders older than 80 mins and upto 10 days" | mailx -r "oms_auto_notification@vitaminshoppe.com" -s "No DTC orders are stuck in Created status with Fraud Hold.Count:$orderCount3" $FRAUD_ADDRS
...
then
echo -e "No DTC orders are stuck in Created status.\n\nScript Name:Orders_Stuck_Created_Status.sh \nCriteria: Orders older than 80 mins and upto 10 days" | mailx -r "oms_auto_notification@vitaminshoppe.com" -s "No DTC orders are stuck in Created status.Count:$orderCount5" $DTC_ADDRS
