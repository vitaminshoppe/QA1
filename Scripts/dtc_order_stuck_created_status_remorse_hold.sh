#!/bin/ksh
#
#su -  c /home/OMSAutomationScripts/dtc_order_stuck_created_status_remorse_hold.sh
...
DTC_ADDRS="oms@vitaminshoppe.com"

export LOGDIR ARCDIR PATH ORACLE_HOME USER PWD DTC_ADDRS TO_ADDRS_ON_FAILURE
