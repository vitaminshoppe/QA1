	...
	<table  class="view">
			<tr >
					<td >
							...
							<input type="hidden" name='xml:/OrderLine/@ItemGroupCode' value='DS'  />
					</td>
			</tr>
			<jsp:include page="/yfsjspcommon/common_fields.jsp" flush="true">
				...
				<jsp:param name="RefreshOnDocumentType" value="false"/>
			</jsp:include>
			...
			<%
				String extraParam = "IsReturnService=" + getParameter("isReturnService");
			%>
			...
			<tr >
					<td  nowrap="true" class="searchcriteriacell">
							...
							<img class="lookupicon" name="search" onclick="callServiceItemLookup('xml:/OrderLine/Item/@ItemID','xml:/OrderLine/Item/@ProductClass','xml:/OrderLine/Item/@UnitOfMeasure','item','DS', '<%=extraParam%>')" <%=getImageOptions(YFSUIBackendConsts.LOOKUP_ICON, "Search_for_Item")%>/>
					</td>
			</tr>
			<tr >
					<td  class="searchlabel">
