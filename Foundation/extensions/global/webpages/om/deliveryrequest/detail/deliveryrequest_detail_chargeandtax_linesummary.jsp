...
<thead>
    <tr>
		...
		<% if (isForReturn) { %>
			<td class="numerictablecolumnheader" style="width:<%=getUITableSize("xml:/OrderLine/LineOverallTotals/@Discount")%>"><yfc:i18n>Discount_Always</yfc:i18n></td>
			<td class="numerictablecolumnheader" style="width:<%=getUITableSize("xml:/OrderLine/LineOverallTotals/@Charges")%>"><yfc:i18n>Pickup_Charges</yfc:i18n></td>
		<% } else {%>
