...
<table class="view">
    ...
    <tr>
        <td class="searchcriteriacell" nowrap="true">
            ...
            <input class="unprotectedinput" type="text" <%=getTextOptions("xml:/OrderLine/Item/@CustomerItem")%>/>
        </td>
    </tr>
    <tr>
        <td class="searchlabel" >
            <yfc:i18n>Customer_PO#</yfc:i18n>
        </td>
    </tr>
    <tr>
        <td class="searchcriteriacell" nowrap="true">
            ...
            <input class="unprotectedinput" type="text" <%=getTextOptions("xml:/OrderLine/@CustomerPONo")%>/>
        </td>
    </tr>
</table>
