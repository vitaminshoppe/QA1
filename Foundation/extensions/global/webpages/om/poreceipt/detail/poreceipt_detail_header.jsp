...
<table class="view" width="100%">
    ...
    <tr>
        ...
        <td class="protectedtext" ><yfc:getXMLValue binding="xml:/Receipt/Order/OrderLines/OrderLine/@ReceivingNode" /> </td>
        <td class="detaillabel">
            <yfc:i18n>SCAC</yfc:i18n>
        </td>
        <%if (modify) {%>
		<td>
            <select class="combobox" <%=getComboOptions("xml:/Receipt/@Scac")%>>
				<yfc:loopOptions binding="xml:ScacList:/OrganizationList/@Organization" name="OrganizationCode"
                    value="OrganizationCode" selected="xml:/Receipt/@Scac" />
            </select>
		</td>	
        <%} else { %>
		<td class="protectedtext" >
                <% String scac = resolveValue("xml:/Receipt/@Scac");%>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="<%=(modify?"unprotectedinput":"protectedinput")%>" <%=getTextOptions("xml:/Receipt/@BolNo")%>/>
        </td>
        <td class="detaillabel">
            <yfc:i18n>PRO_#</yfc:i18n>
        </td>
        <td>
            <input type="text" class="<%=(modify?"unprotectedinput":"protectedinput")%>" <%=getTextOptions("xml:/Receipt/@ProNo")%>/>
        </td>
        <td class="detaillabel">
            <yfc:i18n>Number_Of_Pallets</yfc:i18n>
        </td>
        <td>
	...
	<tr>
		<td class="detaillabel">
            <yfc:i18n>Number_Of_Cartons</yfc:i18n>
        </td>
        <td>
