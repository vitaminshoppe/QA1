...
<%
	...
	if (!isVoid(inputStr)) {
		...
		tempElem = YFCDocument.parse("<OrderLineList TotalNumberOfRecords=\"\" ><OrderLine><Item/></OrderLine></OrderLineList>").getDocumentElement();
	}

%>

	<yfc:callAPI apiName="getOrderLineList" inputElement="<%=inElem%>" 
	templateElement="<%=tempElem%>" outputNamespace=""/>

<%
	
	YFCElement outElem = (YFCElement)request.getAttribute("OrderLineList");
