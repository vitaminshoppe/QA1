...
<%
	...
	if (!isVoid(inputStr)) {
		...
		tempElem = YFCDocument.parse("<ActivityDemands><ActivityDemand/></ActivityDemands>").
		getDocumentElement();
	}

%>

	<yfc:callAPI apiName="getActivityDemandList" inputElement="<%=inElem%>" 
	templateElement="<%=tempElem%>" outputNamespace=""/>

<%
	
	YFCElement outElem = (YFCElement)request.getAttribute("ActivityDemands");
