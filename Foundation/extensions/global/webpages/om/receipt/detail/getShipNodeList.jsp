...
<%
	...
	if (!isVoid(inputStr)) {
		...
		tempElem = YFCDocument.parse("<ShipNodeList><ShipNode SerialTracking=\"\"/></ShipNodeList>").getDocumentElement();
	}

%>

	<yfc:callAPI apiName="getShipNodeList" inputElement="<%=inElem%>" 
	templateElement="<%=tempElem%>" outputNamespace=""/>

<%
	
	YFCElement outElem = (YFCElement)request.getAttribute("ShipNodeList");
