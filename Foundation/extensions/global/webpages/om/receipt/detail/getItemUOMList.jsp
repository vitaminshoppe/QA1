...
<%
	...
	if (!isVoid(inputStr)) {
		...
		tempElem = YFCDocument.parse("<ItemUOMList><ItemUOM><Item/></ItemUOM></ItemUOMList>").getDocumentElement();
	}

%>

	<yfc:callAPI apiName="getItemUOMList" inputElement="<%=inElem%>" 
	templateElement="<%=tempElem%>" outputNamespace=""/>

<%
	
	YFCElement outElem = (YFCElement)request.getAttribute("ItemUOMList");
