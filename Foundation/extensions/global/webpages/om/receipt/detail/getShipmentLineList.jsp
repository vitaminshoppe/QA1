...
<%
	...
	if (!isVoid(inputStr)) {
		...
		tempElem = YFCDocument.parse("<ShipmentLines TotalNumberOfRecords=\"\" ><ShipmentLine/></ShipmentLines>").getDocumentElement();
	}

%>

	<yfc:callAPI apiName="getShipmentLineList" inputElement="<%=inElem%>" 
	templateElement="<%=tempElem%>" outputNamespace=""/>

<%
	
	YFCElement outElem = (YFCElement)request.getAttribute("ShipmentLines");
