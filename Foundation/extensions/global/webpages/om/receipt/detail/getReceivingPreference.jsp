...
<%
	...
	if (!isVoid(inputStr)) {
		...
		tempElem = YFCDocument.parse("<ReceivingPreference/>").getDocumentElement();
	}


%>
	<yfc:callAPI apiName="getReceivingPreference" inputElement="<%=inElem%>" 
	templateElement="<%=tempElem%>" outputNamespace=""/>

<%
	
	YFCElement outElem = (YFCElement)request.getAttribute("ReceivingPreference");
