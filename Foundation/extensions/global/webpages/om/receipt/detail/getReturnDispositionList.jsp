...
<%
	...
	if (!isVoid(inputStr)) {
		...
		tempElem = YFCDocument.parse("<ReturnDispositionList><ReturnDisposition/></ReturnDispositionList>").
			getDocumentElement();
	}
...
%>
	...
	<yfc:callAPI apiName="getReturnDispositionList" inputElement="<%=inElem%>" 
	templateElement="<%=tempElem%>" outputNamespace=""/>

<%
	
	YFCElement outElem = (YFCElement)request.getAttribute("ReturnDispositionList");
