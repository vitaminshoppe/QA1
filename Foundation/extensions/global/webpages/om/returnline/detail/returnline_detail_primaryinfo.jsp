...
<tr>
    <td>
		<yfc:hasXMLNode binding="xml:/OrderLine/@OrigOrderLineKey">
			...
			<input type="hidden" name="OrigOrderLineKey" value="<%=getParameter("origOrderLineKey")%>"/>
		</yfc:hasXMLNode>
...
<tr>
    ...
    <yfc:makeXMLInput name="orderKey">
        ...
        <yfc:makeXMLKey binding="xml:/Order/@OrderNo" value="xml:/OrderLine/Order/@OrderNo" ></yfc:makeXMLKey>
        <yfc:makeXMLKey binding="xml:/Order/@EnterpriseCode" value="xml:/OrderLine/Order/@EnterpriseCode" ></yfc:makeXMLKey>
    </yfc:makeXMLInput>
    ...
    <td class="protectedtext">
		<% if(showOrderNo("OrderLine","Order")) {%>
			<a <%=getDetailHrefOptions("L01",getParameter("orderKey"),"")%>><yfc:getXMLValue binding="xml:/OrderLine/Order/@OrderNo"></yfc:getXMLValue></a>&nbsp;
		<%} else {%>
    ...
    <td class="detaillabel" ><yfc:i18n>Line_Quantity</yfc:i18n>
    </td>
