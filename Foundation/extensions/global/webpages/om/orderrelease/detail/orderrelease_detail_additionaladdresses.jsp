...
<%  ArrayList addressTypeList = getLoopingElementList("xml:AddressTypeList:/CommonCodeList/@CommonCode");
    ...
    <% ArrayList additionalAddressList = getLoopingElementList("xml:/OrderRelease/Order/AdditionalAddresses/@AdditionalAddress");
        ...
        %>
                ...
                <td height="100%" width="<%=widthValue%>" style="padding-top:5;padding-left:5" addressip="true">
                    ...
                    <%outputPath = "xml:/OrderRelease/Order/AdditionalAddresses/AdditionalAddress_" + addressCounter + "/PersonInfo";
                      outputAddressTypePath = "xml:/OrderRelease/Order/AdditionalAddresses/AdditionalAddress_" + addressCounter;
                      addressCounter++;
                    %>
				    ...
				    <jsp:include page="/yfc/innerpanel.jsp" flush="true" >
                        ...
                        <jsp:param name="AllowedModValue" value='<%=getModificationAllowedValueWithPermission("AdditionalAddress", "xml:/OrderRelease/AllowedModifications")%>'/>
                    </jsp:include>
                </td>
        <% } %>
    <% } %>
    ...
    <% } %>
<% } %>
<%  ArrayList addAddressList = getLoopingElementList("xml:/OrderRelease/Order/AdditionalAddresses/@AdditionalAddress");
