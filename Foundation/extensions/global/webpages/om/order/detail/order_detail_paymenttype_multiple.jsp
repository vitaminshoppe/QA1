        ...
        <table class="view" width="100%">
            <tr>
                <td>
                    ...
                    <!--input type="hidden" value='<%=getParameter("modifyPaymentKey")%>' name="ModifyPaymentMethodKey"/-->
			...
			<% } else if (equals(paymentTypeGroup,"DEBIT_CARD")) { %> 
                <tbody>
                <jsp:include page="/om/order/detail/order_detail_paymenttype_debitcard.jsp" flush="true">
                    <jsp:param name="Incomplete" value='<%=incomplete%>'/>
                    <jsp:param name="Path" value='<%=path%>'/>
					<jsp:param name="PaymentTypeBinding" value="xml:/PaymentMethod/@PaymentType"/>
					<jsp:param name="PaymentMethodKey" value="xml:/PaymentMethod/@PaymentKey"/>
