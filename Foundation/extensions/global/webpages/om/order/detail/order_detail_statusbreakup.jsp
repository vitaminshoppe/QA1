...
<thead>
    <tr>
		...
		<td class=tablecolumnheader style="width:<%= getUITableSize("xml:/OrderLineStatusList/OrderStatus/OrderLine/@CancelReasonDesc")%>"><yfc:i18n>Cancel_Reason</yfc:i18n></td>
	...
	<% if (equals(getValue("OrderStatus","xml:/OrderStatus/OrderLine/@ItemGroupCode"), "PROD") )
		...
		{%>
			<tr>
				...
				<td class="tablecolumn"><yfc:getXMLValue binding="xml:/OrderStatus/OrderLine/@CancelReasonDesc"/>					
				</td>
