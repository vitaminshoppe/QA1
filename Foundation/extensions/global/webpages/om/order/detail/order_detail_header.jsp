...
<table class="view" width="100%">
    ...
    <tr>
        ...
        <td class="detaillabel" ><yfc:i18n>Customer</yfc:i18n></td>
	     <td class="protectedtext"><yfc:getXMLValue binding="xml:/Order/@BillToID"/></td>
        <td class="detaillabel" ><yfc:i18n>Selling Store</yfc:i18n></td>
    ...
    <tr>
        ...
        <td class="protectedtext"><%=getComboText("xml:OrderTypeList:/CommonCodeList/@CommonCode","CodeShortDescription","CodeValue","xml:/Order/OrderLines/OrderLine/@LineType",true)%></td>    
