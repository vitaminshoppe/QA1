...
<table class="table" editable="false" width="100%" cellspacing="0">
    <thead> 
        <tr>
            ...
            <td class="tablecolumnheader"><yfc:i18n>Customer</yfc:i18n></td>
    ...
    <tbody>
        <yfc:loopXML binding="xml:/OrderList/@Order" id="Order">
            <tr>
                ...
                <td class="tablecolumn"><yfc:getXMLValue binding="xml:Order/@CustomerFirstName"/> <yfc:getXMLValue binding="xml:Order/@CustomerLastName"/></td>
