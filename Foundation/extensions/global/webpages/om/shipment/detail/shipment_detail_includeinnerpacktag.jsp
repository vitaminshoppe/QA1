...
<tbody>
	      <yfc:loopXML binding="xml:/ContainerInnerPacks/@ContainerInnerPack" id="ContainerInnerPack">
			 <%
			...
			if (equals(myInteger,ContainerInnerPackCounter)){%>
			 <yfc:loopXML binding="xml:/ContainerInnerPack/ShipmentTagSerials/@ShipmentTagSerial" id="ShipmentTagSerial">
			 <tr>
			...
			<%//prompt for serial no if serialized 
	   		if(equals("Y",getValue("ItemDetails","xml:/Item/PrimaryInformation/@SerialCapturedInShipping"))||equals("Y",getValue("ItemDetails","xml:/Item/PrimaryInformation/@SerialCapturedInReturns"))){%>
				...
				<yfc:makeXMLInput name="serialKey" >
					...
					<yfc:makeXMLKey binding="xml:/Container/@ItemID" value="xml:/ContainerInnerPack/@ItemID"/>
					<yfc:makeXMLKey binding="xml:/Container/@ProductClass" value="xml:/ContainerInnerPack/@ProductClass"/>
					<yfc:makeXMLKey binding="xml:/Container/@UnitOfMeasure" value="xml:/ContainerInnerPack/@UnitOfMeasure"/>
				</yfc:makeXMLInput>
