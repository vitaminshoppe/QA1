...
<%	
	...
	if(equals("Y", useFeeNotDiscount) && equals("DS", getParameter("ItemGroupCode") ) )	{
		useFeeNotDiscount = " ";	//	fees does not make sence for return ds
	}
%>
...
<thead>
    <tr>
        ...
        <td class="tablecolumnheader" style="width:<%=getUITableSize("xml:/InvoiceDetail/InvoiceHeader/LineDetails/LineDetail/@OptionPrice")%>"><yfc:i18n>Option_Price</yfc:i18n></td>
...
<tbody> 
	...
	<%	if(equals(resolveValue("xml:/LineDetail/OrderLine/@ItemGroupCode"), getParameter("ItemGroupCode") ) )	{	%>
    ...
    <tr>
        ...
        <td class="numerictablecolumn" sortValue="<%=getNumericValue("xml:LineDetail:/LineDetail/@OptionPrice")%>">
            <yfc:getXMLValue binding="xml:/LineDetail/@OptionPrice"/>
        </td>
