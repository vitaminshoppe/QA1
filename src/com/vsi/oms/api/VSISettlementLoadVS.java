...
/**
 * This class is called by service VSISettlementLoadVS to load settlements data to custom tables.
 * 
 * @author IBM
 * 
 */

public class VSISettlementLoadVS {
	private YFCLogCategory log = YFCLogCategory
			.instance(VSISettlementLoadVS.class);
	YIFApi api;
...
<VSISetlTransCharge ChargeType="Principal" ChargeAmount="200" PromotionId="" />
	...
	public Document createSetlTransactionInputDoc(Element eleSettlement) throws ParserConfigurationException
	{
		...
		try {
			...
			eleVSISetlTransaction.setAttribute(VSIConstants.ATTR_EXTN_STORE_FRONT, VSIConstants.VS_AMAZON);
 ...
 */
	...
	public Document createSetttlementInputDoc(Element eleSettlement) throws ParserConfigurationException
	{
		...
		try {
			...
			eleVSISettlement.setAttribute(VSIConstants.ATTR_EXTN_STORE_FRONT, VSIConstants.VS_AMAZON);
