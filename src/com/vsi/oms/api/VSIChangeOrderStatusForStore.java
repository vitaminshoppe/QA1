...
public class VSIChangeOrderStatusForStore {

	private YFCLogCategory log = YFCLogCategory.instance(VSIChangeOrderStatusForStore.class);
	YIFApi api;
	public void vsiStoreReceived(YFSEnvironment env, Document inXML)
			throws Exception {
		if(log.isDebugEnabled()){
			log.info("================Inside VSIChangeOrderStatusForStore================================");
