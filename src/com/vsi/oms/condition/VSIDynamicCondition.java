...
public class VSIDynamicCondition implements YCPDynamicCondition
{
	...
	public boolean evaluateCondition(YFSEnvironment env, String condName,
		...
		try{
			...
			YFCElement shipmentLineElement = inputXML.getElementsByTagName(VSIConstants.ELE_SHIPMENT_LINE).item(0);	
					
			String CustPoNo = shipmentLineElement.getAttribute(VSIConstants.ATTR_ORDER_NO);
